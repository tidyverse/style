...
The problem statement should use sentence case. If a single sentence, it should not end with a full stop. If two or more sentences, each of those should end with a full stop.
...
If there are multiple issues, or an inconsistency revealed across several arguments or items, prefer a bulleted list. Each bullet point should end with a full stop if it is a sentence, or if it completes a sentence:
