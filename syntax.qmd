...
Braced expressions, `{}`, define the most important hierarchy of R code. To make this
...
It is occassionally useful to have empty braced expressions, in which case it should be written `{}`.
...
* A multiline if statement must contain braced expressions.
  ...
  # In particular, the outer braces are required for this to even parse.
  {
    if (x > 10)
      x * 2
    else
