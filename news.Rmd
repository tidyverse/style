...
Functions and arguments should be wrapped in backticks, and function names
should include parentheses. Both `NAMESPACE`, and `DESCRIPTION` should be 
surrounded by backticks, as well.
...
During development, new bullets should be added to top of the file, immediately under an "development" heading:
