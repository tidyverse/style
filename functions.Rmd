...
If using an anonymous or inline function (i.e. a function that hasn't been given a name by assigning it to a variable), prefer the new lambda syntax: `\(x) x + 1`.
...
* As with any function, prefer informative argument names.
* Only use an anonymous function if it fits on one line.
