...
If the function name and definition can't fit on a single line, place each argument on its own double indented line. The trailing `)` and leading `{` should go on their own line.
