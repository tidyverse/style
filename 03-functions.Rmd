...
If your function is called primarily for its side-effects, it should return the first argument invisibly. This makes it possible to use the function as part of a pipe. `print` methods should usually do this, like this example from httr:
...
*   A function should do one thing well. 
    ...
    a function on one screen, < 30 lines.
