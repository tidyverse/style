...
If your function is called primarily for its side-effects, it should return the first argument invisibly. (This makes it possible to use the function as part of the pipe.)
