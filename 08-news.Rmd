...
Within a section, bullets should be ordered alphabetically by the first function mentioned (which should be near the start of the sentence). Bullets that don't mention a function come first.
