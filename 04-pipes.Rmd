...
Personally, I think you should avoid this technique. While starting with the assignment is a little more work when writing the code, it makes reading the code easier. The name acts as a heading, which reminds you of the purpose of the code.
